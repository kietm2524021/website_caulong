...
SECRET_KEY = os.getenv("SECRET_KEY", "django-local-insecure-secret-key")
DEBUG = True
...
CACHES = {
    "default": {
        ...
        "LOCATION": "badminton-security-cache-local",
    }
}
...
JAZZMIN_SETTINGS = {
    "site_title": "Cầu Lông Bạc Liêu (Local)",
    "site_header": "Cầu Lông Bạc Liêu",
    "site_brand": "Cầu Lông Bạc Liêu",
    "welcome_sign": "Quản trị local",
