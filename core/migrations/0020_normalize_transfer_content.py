...
def normalize_transfer_content(apps, schema_editor):
    ...
    for booking in bookings:
        ...
        raw = f"DAT COC {phone} {booking.ngayBatDau:%d%m%Y} {booking.san.tenSan}"
...
class Migration(migrations.Migration):
    dependencies = [('members', '0019_thongbao_duong_dan_thongbao_loai')]

    operations = [migrations.RunPython(normalize_transfer_content, migrations.RunPython.noop)]
